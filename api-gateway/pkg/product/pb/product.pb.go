...
func (x *CreateProductRequset) Reset() {
	*x = CreateProductRequset{}
...
func (x *CreateProductRequset) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateProductRequset) ProtoMessage() {}

func (x *CreateProductRequset) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_product_pb_product_proto_msgTypes[0]
...
// Deprecated: Use CreateProductRequset.ProtoReflect.Descriptor instead.
func (*CreateProductRequset) Descriptor() ([]byte, []int) {
	return file_pkg_product_pb_product_proto_rawDescGZIP(), []int{0}
}

func (x *CreateProductRequset) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *CreateProductRequset) GetSku() string {
	if x != nil {
		return x.Sku
	}
	return ""
...
func (x *CreateProductRequset) GetStock() int64 {
	if x != nil {
		return x.Stock
	}
	return 0
...
func (x *CreateProductRequset) GetPrice() int64 {
	if x != nil {
		return x.Price
	}
	return 0
...
type CreateProductResponse struct {
	...
	ProductInfoId int64  `protobuf:"varint,3,opt,name=productInfoId,proto3" json:"productInfoId,omitempty"`
}
...
func (x *CreateProductResponse) GetProductInfoId() int64 {
	if x != nil {
...
type FindOneData struct {
	...
	ProductInfoId int64  `protobuf:"varint,1,opt,name=productInfoId,proto3" json:"productInfoId,omitempty"`
...
func (x *FindOneData) GetProductInfoId() int64 {
	if x != nil {
		return x.ProductInfoId
	}
	return 0
...
func (x *FindOneRequest) GetProductInfoId() int64 {
	if x != nil {
		return x.ProductInfoId
	}
	return 0
...
type DecreaseStockRequest struct {
	...
	ProductInfoId int64 `protobuf:"varint,1,opt,name=productInfoId,proto3" json:"productInfoId,omitempty"`
	OrderInfoId   int64 `protobuf:"varint,2,opt,name=orderInfoId,proto3" json:"orderInfoId,omitempty"`
}
...
func (x *DecreaseStockRequest) GetProductInfoId() int64 {
	if x != nil {
		return x.ProductInfoId
	}
	return 0
...
func (x *DecreaseStockRequest) GetOrderInfoId() int64 {
	if x != nil {
		return x.OrderInfoId
	}
	return 0
}
...
var file_pkg_product_pb_product_proto_rawDesc = []byte{
	...
	0x65, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x52, 0x65, 0x71, 0x75, 0x73, 0x65, 0x74, 0x12,
	...
	0x65, 0x22, 0x6b, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x64, 0x75,
	...
	,
	...
	0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x22, 0x36, 0x0a, 0x0e, 0x46, 0x69, 0x6e, 0x64, 0x4f, 0x6e,
	0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x24, 0x0a, 0x0d, 0x70, 0x72, 0x6f, 0x64,
	0x75, 0x63, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x0d, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x49, 0x64, 0x22, 0x69,
	...
	0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x5e, 0x0a, 0x14, 0x44, 0x65, 0x63,
	0x72, 0x65, 0x61, 0x73, 0x65, 0x53, 0x74, 0x6f, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x24, 0x0a, 0x0d, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x49, 0x6e, 0x66, 0x6f,
	0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63,
	0x74, 0x49, 0x6e, 0x66, 0x6f, 0x49, 0x64, 0x12, 0x20, 0x0a, 0x0b, 0x6f, 0x72, 0x64, 0x65, 0x72,
	0x49, 0x6e, 0x66, 0x6f, 0x49, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x6f, 0x72,
	0x64, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x49, 0x64, 0x22, 0x45, 0x0a, 0x15, 0x44, 0x65, 0x63,
	...
	0x73, 0x65, 0x74, 0x1a, 0x1e, 0x2e, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x2e, 0x43, 0x72,
...
var file_pkg_product_pb_product_proto_goTypes = []interface{}{
	(*CreateProductRequset)(nil),  // 0: product.CreateProductRequset
...
var file_pkg_product_pb_product_proto_depIdxs = []int32{
	...
	0, // 1: product.ProductService.CreateProduct:input_type -> product.CreateProductRequset
...
func file_pkg_product_pb_product_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_product_pb_product_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateProductRequset); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
