...
type UsersClient interface {
	...
	GetProfile(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetProfileResponse, error)
}
...
func (c *usersClient) GetProfile(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetProfileResponse, error) {
...
type UsersServer interface {
	...
	GetProfile(context.Context, *Empty) (*GetProfileResponse, error)
...
func (UnimplementedUsersServer) GetProfile(context.Context, *Empty) (*GetProfileResponse, error) {
...
func _Users_GetProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsersServer).GetProfile(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
